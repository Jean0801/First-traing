...
@section('main')
    <main>
        <div class="container">
            <h2>{{$article->title}}</h2>
            <div class="inf-list">
                <span>作者<p>{{$article->auther1}}</p></span>
                <span>發布時間<p>{{$article->created_at}}</p></span>
            </div><br>
            <hr>
            <article>
                ...
                POINTS，邀請大家一訪再訪，挖掘專屬自己的小鎮新玩法！<br><br>
                另外，交通部觀光局除了於5月5日台灣自行車日在八里辦理「踩動臺灣，多元暢遊」活動，結合「百大經典小鎮護照」設置「與喔熊騎環島」展攤活動與喔熊玩遊戲外，也評選出30條自行車多元化遊程，遊程囊括全臺多元風情，創新且豐富的面向讓自行車觀光再升級，遊程資訊可上網站查詢。<br><br>
